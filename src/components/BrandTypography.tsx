...
const BrandTypography = React.forwardRef<HTMLElement, TypographyProps>(
  (
    ...
    const variantClasses = {
      ...
      'mission-briefing':
        'text-mission-briefing font-black text-command-100 tracking-tight',
      'command-directive': 'text-command-directive font-bold text-command-200',
      'tactical-heading':
        'text-tactical-heading font-semibold text-tactical-200',
      'operational-title':
        'text-operational-title font-semibold text-strategic-200',

      // Strategic Content Typography
      'strategic-body':
        'text-strategic-body text-strategic-200 leading-relaxed',
      'field-report': 'text-field-report text-strategic-300 leading-relaxed',
      'intelligence-brief':
        'text-intelligence-brief text-strategic-400 leading-normal',
      'status-indicator':
        'text-status-indicator font-medium text-command-300 uppercase tracking-wider',
      ...
      'intelligence-note':
        'text-sm text-strategic-400 leading-normal font-medium',
      'status-badge':
        'text-xs font-bold text-command-400 uppercase tracking-widest',
      'command-label':
        'text-xs font-semibold text-strategic-400 uppercase tracking-wide',
      ...
      // Gradient Text Styles
      'gradient-command':
        'bg-gradient-to-r from-command-400 via-tactical-400 to-command-600 bg-clip-text text-transparent font-black',
      'gradient-hero':
        'bg-gradient-to-r from-command-400 via-tactical-400 to-command-600 bg-clip-text text-transparent font-black',
    };
  ...
  return (
    <span
      ...
      style={
        {
          background:
            'linear-gradient(90deg, #38bdf8 0%, #fb923c 50%, #0ea5e9 100%)',
  ...
  return (
    <h1
      ...
      style={
        {
          background:
            'linear-gradient(135deg, #0ea5e9 0%, #f97316 50%, #fb923c 100%)',
          WebkitBackgroundClip: 'text',
          WebkitTextFillColor: 'transparent',
          backgroundClip: 'text',
...
export const TypographyShowcase: React.FC<TypographyShowcaseProps> = ({
  ...
  const typographyVariants: Array<{
    ...
    },
    {
      ...
      example:
        'Precision-engineered microtools for project management excellence.',
    },
    {
      variant: 'field-report',
      name: 'Field Report',
      ...
      example:
        'Advanced pattern recognition and predictive insights for superior decision-making.',
    },
    {
      variant: 'intelligence-brief',
    ...
    <div className={cn('space-y-8', className)}>
        ...
        >
          <div className="mb-4 flex items-center justify-between">
            <div>
              ...
              <div className="text-sm font-medium text-tactical-300">
                {name}
              </div>
            </div>
          ...
          {variant === 'gradient-command' ? (
            ...
            <BrandTypography variant={variant}>{example}</BrandTypography>
          )}
        </div>
      ))}
      ...
      <div className="overflow-hidden rounded-lg border border-strategic-800/30 bg-strategic-950/50 p-6">
        <div className="mb-4 flex items-center justify-between">
          ...
          <div className="text-xs text-strategic-400">
            Hero gradient for main titles with mission briefing size
          </div>
        </div>
