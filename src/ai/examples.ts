...
export const RACI_EXAMPLES = [
  {
    description:
      'Mobile app development project with user authentication and payment features. Team includes PM, developers, QA, and product owner.',
    result: {
      roles: [
  ...
  {
    description:
      'Website redesign project involving marketing team, web developers, and external design agency.',
    result: {
      roles: [
